...
if __name__ == "__main__":
    ppd = np.array([4]) # np.array([2, 3, 4])#  5])
    N = ppd**3
    eta = [2, 3]# , 6, 7, 8, 9, 10, 11, 12, 13]
    L = 5.
    strang_delta_spectral_norm = np.array([0.8561560605566017,
                                           1.6574473305212063,
                                           ])
    suzuki_4_delta_spectral_norm = np.array([0.8434806310656602,
                                             1.577553450461979,
                                             ])

    suzuki_6_delta_spectral_norm = np.array([0.7075821919466451,
                                             1.0556530086283187,
                                             ])

    berry_8_delta_spectral_norm = np.array([0.4389501330501588,
                                            0.503108063718147,
                                                ])
    ...
    plt.gcf().subplots_adjust(bottom=0.15, left=0.2)
    plt.savefig("delta_spectral_norms_grid_scaling_N64.png", dpi=300, format='PNG')
    plt.savefig("delta_spectral_norms_grid_scaling_N64.pdf", dpi=300, format='PDF')
    ...
    # plt.gcf().subplots_adjust(bottom=0.15, left=0.2)
    plt.savefig("delta_scaled_spectral_norm_grid_scaling_N64.png", dpi=300, format='PNG')
    plt.savefig("delta_scaled_spectral_norm_grid_scaling_N64.pdf", dpi=300, format='PDF')

    print(berry_8_constant_factors)
