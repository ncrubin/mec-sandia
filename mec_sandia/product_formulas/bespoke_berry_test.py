...
def test_berry_eight_order():
    ...
    sz = 0
    h1 = np.asarray(mol_mf.get_hcore(), dtype=np.complex128)
    of_eris = np.array(mol_mf._eri.transpose((0, 2, 3, 1)), dtype=np.complex128)
